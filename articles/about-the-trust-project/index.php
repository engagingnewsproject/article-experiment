...
<main id="content" class="container about-trust-project" role="main">
    <article class="article">
        ...
        <p>The Trust Project uses six trust indicators to evaluate the trustworthiness of a news organization. The Gazette Star adheres to all of them:</p>
        ...
        <p>The Gazette Star is committed to telling readers when an error has been made, the magnitude of the error, and the correct information, as quickly as possible. This commitment and transparency is applicable to small errors as well as large, to short news summaries as well as large feature pieces. If our audiences cannot trust us to get the small things right, how can they trust us on the big things?</p>
        ...
        <p>The Gazette Star is committed to transparency in our ownership structure and funding sources. We cite potential conflicts of interest on the same page as the relevant work. We are part of a publicly traded company and business decisions, but not news decisions, must take shareholder value in mind.</p>
